/* ============================================================
   ...
   Edit content here. Both languages kept in sync by key.
   ============================================================ */
window.CV = {
  ...
  // Technology graph for the 3D hero (architecture map).
  // group drives color; key links express data flow.
  graph: {
    nodes: [
  ...
  // Tech stack — categorized. Used by the 3D sphere + stack section.
  stack: [
  ...
  // soft skills (inferred from described work)
  soft: {
    ru: [
  ...
  ru: {
    ...
    sections: {
      ...
      education: "Образование",
      skills: "Навыки",
      github: "Open-source и активность",
